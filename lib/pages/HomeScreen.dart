...
import 'package:nmlsalesaccess/model/ScanQrCodeModel.dart';
import 'package:nmlsalesaccess/model/VersionCheckModel.dart';
import 'package:permission_handler/permission_handler.dart';
import 'package:url_launcher/url_launcher.dart';
import '../model/SaveMobileAppKeyModel.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  var _name = "", _empID = "", _mobile = "", _design = "", _dept = "", _activeDevice = "";
  ...
  Future qrcodeScan() async {
    ...
    if (cameraStatus.isGranted) {
      ...
      scanQRCode(widget.userInfo.empId, identifier, qrData);
    } else {
  ...
  Future<void> scanQRCode(String? empID, String deviceID, String? qrCode) async {
    ...
    if (response.statusCode == 200) {
      ...
      print(jsonResponse);
      ScanQrCodeModel scanQrCodeModel = ScanQrCodeModel.fromJson(jsonResponse);
  ...
  Future<void> saveMobileAppKey() async {
    ...
    String params = "EmpID=$empID&Mobileappkey=$mobileAppKey&deviceID=$identifier";
    final response = await ApiManager.saveMobileAppKey(params);
    if (response.statusCode == 200) {
      var jsonResponse =
      convert.jsonDecode(response.body) as Map<String, dynamic>;
      print(jsonResponse);
      SaveMobileAppKeyModel saveMobileAppKeyModel = SaveMobileAppKeyModel.fromJson(jsonResponse);
  ...
  Future checkVersion() async {
    ...
    if (response.statusCode == 200) {
      ...
      convert.jsonDecode(response.body) as Map<String, dynamic>;
      print(jsonResponse);
      VersionCheckModel versionCheckModel = VersionCheckModel.fromJson(jsonResponse);
